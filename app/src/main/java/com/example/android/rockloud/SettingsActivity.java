...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * DISPLAY TOAST MESSAGE FOR 'SettingsActivity'
         * 1. Find the Parent View that shows the 'SettingsActivity'
         ...
         */
        RelativeLayout objSettingsActivity = (RelativeLayout) findViewById(R.id.reloSettingsActivity);
        objSettingsActivity.setOnClickListener(new View.OnClickListener() {
            @Override
