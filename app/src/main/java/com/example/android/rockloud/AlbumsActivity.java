...
public class AlbumsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * DISPLAY TOAST MESSAGE FOR 'AlbumsActivity'
         * 1. Find the Parent View that shows the 'AlbumsActivity'
         ...
         */
        RelativeLayout objAlbumsActivity = (RelativeLayout) findViewById(R.id.reloAlbumsActivity);
        objAlbumsActivity.setOnClickListener(new View.OnClickListener() {
            @Override
